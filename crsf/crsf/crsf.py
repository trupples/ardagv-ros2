...
class CRSFNode(Node):
    def __init__(self):
        ...
        self.cmd_publisher = self.create_publisher(TwistStamped, 'cmd_vel_mux', 1) # Multiplexed velocity
        self.forward_publisher = self.create_publisher(Float64MultiArray, 'forward_mux', 1) # Multiplexed inverse kinematics
        ...
        self.cli = self.create_client(CORead, '/motor_left/sdo_read')
    ...
    def battery_timer_callback(self):
        ...
        self.get_logger().info('Requesting battery')
    ...
    def battery_value_callback(self, future):
        ...
        self.get_logger().info('Got battery')
